      ...
      <div className="font-Jakarta">
        ...
        <div className="flex justify-center items-center ml-5 mt-10">
          <div className="flex-row-2">
            ...
            <button onClick={() => navigate("/student/class/quiz")} className="mt-3 px-[4.3rem] py-2 border border-solid border-neutral-500 bg-white text-black rounded hover:bg-indigo-700 hover:text-white transition-all flex">Home</button>
          </div>
        </div>
      </div>
    );
